...
Three bearer-auth'd `GET` endpoints back the M4 content features (`openspec/specs/content-connectors/spec.md`),
...
Teacher mode shares a track as a `.studyos.json` snapshot (`openspec/specs/track-snapshot/spec.md`), served
